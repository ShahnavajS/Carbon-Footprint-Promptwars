    ...
    <Card className={`rounded-2xl border-2 ${ringClass}`}>
      <CardContent className="p-6">
        ...
        <div className="mb-4">
          ...
          <span className="ml-1 text-sm font-bold text-slate-400">kg CO₂ / year</span>
        </div>
    ...
    <div className="min-h-screen bg-slate-50 pb-16 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      ...
      <main className="mx-auto max-w-5xl space-y-8 px-4 py-8">
        ...
        <div className="rounded-2xl border border-emerald-100 bg-emerald-50/40 p-6 text-center dark:border-emerald-900/30 dark:bg-emerald-950/10">
          ...
          <p className="mx-auto mt-1 max-w-xl text-xs leading-relaxed text-slate-600 dark:text-slate-400">
